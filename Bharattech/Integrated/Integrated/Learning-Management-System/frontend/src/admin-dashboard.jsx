...
export default function AdminDashboard() {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen pt-[72px] transition-all duration-300 overflow-x-hidden ${sidebarOpen ? "lg:pl-[220px]" : "lg:pl-0"
          } bg-gray-50`}
      >
                        ...
                        {filteredUsers.map((user) => (
                          <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                            <td className="py-4 px-4 lg:px-6">
                              <div className="flex items-center gap-3">
                                {/* icon circle */}
                                <div className={`w-9 h-9 rounded-lg flex items-center justify-center font-semibold text-white flex-shrink-0 ${user.role === "employee" || user.role === "Employee" ? "bg-blue-600" :
                            ...
                            <td className="py-4 px-4 lg:px-6">
                              <span className={`text-xs px-3 py-1.5 rounded-full font-semibold border ${user.role === "employee" || user.role === "Employee" ? "bg-blue-50 text-blue-700" :
                  ...
                  <div className="md:hidden space-y-4">
                    {filteredUsers.map((user) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center font-semibold text-white flex-shrink-0 ${user.role === "employee" || user.role === "Employee" ? "bg-blue-600" :
                                user.role === "intern" || user.role === "Intern" ? "bg-purple-600" :
                                  user.role === "subadmin" || user.role === "Subadmin" ? "bg-blue-600" :
                                    (user.role || "").toString().toLowerCase() === "admin" ? "bg-red-600" : "bg-gray-600"
                              }`}>
