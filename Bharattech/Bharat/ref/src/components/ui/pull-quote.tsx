    ...
    <section className="py-24 lg:py-32">
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="grid md:grid-cols-[1fr_3fr] gap-10 items-start">
          <span className="font-display text-7xl text-accent leading-none">"</span>
          <motion.div
          ...
          >
            <blockquote className="font-display text-2xl sm:text-3xl lg:text-4xl font-medium text-foreground leading-[1.3] tracking-tight">
              {quote}
            </blockquote>
            <div className="mt-10 flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-accent to-accent/40 flex items-center justify-center text-background font-display font-bold">
                {author.charAt(0)}
              </div>
              <div>
