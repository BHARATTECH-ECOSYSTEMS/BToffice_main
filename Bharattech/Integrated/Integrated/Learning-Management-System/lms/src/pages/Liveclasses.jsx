        ...
        <TabsContent value="upcoming" className="space-y-6 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {upcomingClasses.map((session) => (
              <Card key={session.id} className="hover:shadow-md transition-all border border-gray-200">
        ...
        <TabsContent value="recordings" className="space-y-6 mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {recentRecordings.map((recording) => (
              <Card key={recording.id} className="group hover:shadow-lg transition-all border border-gray-200 overflow-hidden">
