...
export type InterviewPhase =
  | 'introduction'    // AI asks candidate to introduce themselves (name, etc.)
  | 'education'       // Education history + skill set
  | 'project'         // A project the candidate has worked on, explored in depth
  | 'functionality'   // Tech-stack / functionality deep-dive questions on that project
  | 'ending';          // AI concludes, interview complete
...
export interface StudyConfig {
  ...
  // Role details used to let the AI generate interview questions itself,
  // instead of the admin hand-writing every question in coreQuestions.
  // If jobTitle/jobRequirements are filled in and coreQuestions is left
  // empty, the interview prompt derives questions dynamically from these.
  jobTitle?: string;
