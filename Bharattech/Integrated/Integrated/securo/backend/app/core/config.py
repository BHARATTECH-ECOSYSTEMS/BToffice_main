...
class Settings(BaseSettings):
    ...
    oidc_internal_url: str = ""  # internal URL for container backend-to-IDP calls (e.g. http://host.docker.internal:4000)
    oidc_public_url: str = ""  # public URL for browser redirects (e.g. http://localhost:4000)
    oidc_client_id: str = ""
