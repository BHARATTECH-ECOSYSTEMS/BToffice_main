...
keycloak_config_variables = [
    ...
    {
        "key": "KEYCLOAK_URL",
        "value": os.environ.get("KEYCLOAK_URL", "http://localhost:4000"),
        "category": "KEYCLOAK",
        "is_encrypted": False,
    },
    {
        "key": "KEYCLOAK_INTERNAL_URL",
        "value": os.environ.get("KEYCLOAK_INTERNAL_URL", "http://localhost:4000"),
        "category": "KEYCLOAK",
        "is_encrypted": False,
    },
    {
        "key": "KEYCLOAK_REALM",
        "value": os.environ.get("KEYCLOAK_REALM", "bharattech"),
        "category": "KEYCLOAK",
        "is_encrypted": False,
    },
    {
        "key": "KEYCLOAK_CLIENT_ID",
        "value": os.environ.get("KEYCLOAK_CLIENT_ID", "plane"),
        "category": "KEYCLOAK",
        "is_encrypted": False,
    },
    {
        "key": "KEYCLOAK_CLIENT_SECRET",
        "value": os.environ.get("KEYCLOAK_CLIENT_SECRET", "Cng8aQgy539OmZCWhPN4tQ82nJZke6xtAyrGKhYudrm7lxgza1xyZTUGTHdqiKZLPOSexahVChw6MQmWeXq8bb"),
        "category": "KEYCLOAK",
        "is_encrypted": True,
    },
]
