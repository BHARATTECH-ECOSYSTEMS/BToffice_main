...
const Footer = () => {
  return (
    <footer className="pt-20 pb-0 bg-background overflow-hidden">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              {/* ISO 9001:2015 */}
              <div className="flex items-center justify-center w-14 h-14 rounded-full border-2 border-accent/30 bg-card" title="ISO 9001:2015">
                <div className="text-center leading-none">
                  <div className="text-[8px] font-extrabold text-accent tracking-tight">ISO</div>
                  <div className="text-[7px] font-bold text-foreground tracking-tight mt-0.5">9001</div>
                  <div className="text-[5px] text-muted-foreground tracking-tight mt-0.5">:2015</div>
                </div>
              </div>
              {/* GDPR */}
      ...
      <div className="relative h-48 overflow-hidden flex items-center justify-center">
        ...
        <h2 className="relative z-10 font-display text-[4rem] sm:text-[6rem] lg:text-[8rem] font-bold text-foreground/[0.06] tracking-[0.15em] uppercase select-none leading-none">
          BHARATTECH
        </h2>
      </div>
    </footer>
