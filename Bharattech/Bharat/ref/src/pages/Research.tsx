...
const ResearchSection = ({ icon: Icon, title, description, papers }: {
  ...
  <div className="space-y-8">
    ...
    <div className="grid md:grid-cols-2 gap-6">
      {papers.map((p) => (
        <div key={p.title} className="p-6 rounded-2xl border border-border bg-card hover:border-accent/40 transition-colors cursor-pointer group">
          <h4 className="font-display text-lg font-semibold text-foreground mb-2 group-hover:text-accent transition-colors">{p.title}</h4>
