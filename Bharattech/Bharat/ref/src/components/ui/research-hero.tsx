...
export function ResearchHero({
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(120% 90% at 75% 50%, hsl(235 90% 28%) 0%, hsl(240 80% 15%) 35%, hsl(242 70% 8%) 65%, hsl(244 60% 4%) 100%)",
      }}
    >
      {/* Subtle vignette */}
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -left-32 top-1/3 h-[500px] w-[500px] rounded-full bg-[hsl(230_90%_45%/0.25)] blur-3xl" />
      </div>

      {/* Content */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24 lg:py-36 min-h-[80vh] flex flex-col items-center justify-center text-center">
        <motion.p
