...
export function FeatureCarousel() {
  ...
  return (
    <section className="py-16 bg-brand-bg2 overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          {/* Left: Feature list */}
          <div className="lg:w-[45%] flex flex-col">
            <div className="mb-8">
              <p className="text-xs uppercase tracking-[0.2em] text-brand-muted mb-3">Our Capabilities</p>
              <h2 className="font-display text-3xl sm:text-4xl font-bold text-white leading-tight">
                Everything you need to <span className="text-brand-secondary">build with AI</span>
              </h2>
            </div>
            ...
            >
               <div
                 ...
                 style={{
                   background: `linear-gradient(to bottom, #040406 0%, transparent 15%, transparent 85%, #040406 100%)`,
                 }}
              />
                      ...
                      <button
                        ...
                        onMouseLeave={() => setIsPaused(false)}
                         className={cn(
                           ...
                           isActive
                             ? "bg-white/10 text-brand-secondary border-brand-border shadow-sm z-10"
                             : "bg-transparent text-brand-muted border-brand-border/50 hover:border-brand-border hover:text-white"
                        )}
                      >
