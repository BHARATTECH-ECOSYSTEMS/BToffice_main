...
if /I "%~1"=="run" if /I "%~2"=="dev" (
  "%NODE_EXE%" "%~dp0node_modules\vite\bin\vite.js" --configLoader runner --host 0.0.0.0 --port 5175 --strictPort
  exit /b %ERRORLEVEL%
)
...
if /I "%~1"=="run" if /I "%~2"=="preview" (
  "%NODE_EXE%" "%~dp0node_modules\vite\bin\vite.js" preview --configLoader runner --host 0.0.0.0 --port 5175 --strictPort
  exit /b %ERRORLEVEL%
)
