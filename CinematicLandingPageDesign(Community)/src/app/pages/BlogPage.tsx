    ...
    <div className="bg-white" style={{ fontFamily: 'SF Pro Display, Inter, sans-serif' }}>
      ...
      <section className="py-16 px-8 lg:px-16">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Category filter */}
          <div className="flex gap-1 sm:gap-2 mb-14 bg-[#F5F5F5] rounded-full p-1 w-fit max-w-full">
            {categories.map(c => (
              <button
                key={c}
                onClick={() => setActiveCategory(c)}
                className={`shrink-0 whitespace-nowrap px-2.5 sm:px-5 py-2 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 ${
