...
export default function SubadminResetLinksSection({ resetLinks = [] }) {
  return (
          ...
          {resetLinks.map((link) => (
            <div key={link.id} className="bg-gray-50 p-2.5 sm:p-3 md:p-4 rounded-lg">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-blue-600 underline break-all text-[10px] sm:text-xs md:text-sm block mt-1.5 sm:mt-2 hover:text-blue-700"
              >
                {link.link}
              </a>
